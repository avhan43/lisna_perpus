                            ...
                            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-alt">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a class="link-fx" href="">Data Kategori</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <a href="<?= base_url('kategori/tambah/') ?>" class="btn btn-primary btn-sm"><i class="far fa-plus-square"></i> Tambah Data Kategori</a>
                                    ...
                                    <tr>
                                       ...
                                       <td><?= $k['kategori'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url() ?>/kategori/edit/<?= $k['id']; ?>" class="btn btn-info btn-sm"><i class="far fa-edit"></i></a>
                                            <a href="<?= base_url() ?>/kategori/delete/<?= $k['id']; ?>" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
